...
flags.DEFINE_string('input_shape', None,
                    ...
                    '`[None, None, None, 3]`.')
flags.DEFINE_string('pipeline_config_path', "Z:/DeepLabCut/misc/tensorflow/coco_project_heads/inception_coco/mask_rcnn_inception_v2_coco.config",
                    'Path to a pipeline_pb2.TrainEvalPipelineConfig config '
                    'file.')
flags.DEFINE_string('trained_checkpoint_prefix', "Z:/DeepLabCut/misc/tensorflow/coco_project_heads/inception_coco/models/train/model.ckpt-1127198",
                    'Path to trained checkpoint, typically of the form '
                    'path/to/model.ckpt-10534')
flags.DEFINE_string('output_directory', "Z:/DeepLabCut/misc/tensorflow/coco_project_heads/inception_coco/frozen/", 'Path to write outputs.')
